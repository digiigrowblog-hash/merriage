...
export default function Hero() {
  ...
  return (
    <>
      ...
      <div
        className="fixed top-1/2 -translate-y-1/2 flex justify-center items-center
        ...
        <div className="mx-auto flex max-w-6xl items-center px-6 pt-28 pb-16 gap-10 relative z-30">
          ...
          >
            ...
            >
              <motion.span
                variants={itemVariants}
                className="inline-flex items-center bg-[#ffe6ee] backdrop-blur-sm rounded-2xl px-4 py-2 shadow-xl border border-white/50 z-70"
              >
              ...
              >
                ...
                <br />
                <span className="bg-linear-to-r from-[#fd4f89] via-[#fd4f89] to-[#e2034b] bg-clip-text ">
                  Match
                </span>
              </motion.h1>
              ...
              <motion.p
                variants={itemVariants}
                className="text-lg md:text-xl text-[#190009]/90 leading-relaxed 
              max-w-md mx-auto lg:mx-0 z-70 alike-angular-regular"
              >
                Join <span className="font-semibold text-[#fd4f89] ">5K+</span>{" "}
                successful matches. Verified profiles, smart matching, and
                modern Indian matrimony.
              </motion.p>

              <motion.div
                variants={itemVariants}
                className="flex flex-col sm:flex-row gap-4 items-center justify-center lg:justify-start pt-4 z-70"
              >
                <div className="alike-angular-regular flex items-center gap-6 bg-white/80 backdrop-blur-sm rounded-3xl p-4 shadow-2xl border border-white/50 z-70">
                  <div className="text-center">
                    <div className="text-2xl md:text-3xl font-bold text-[#fd4f89]">
                      5K+
                    </div>
                    <div className="text-xs uppercase text-[#190009]/90 tracking-wide">
                      Happy Couples
                    </div>
                  </div>
                ...
                <Link href="/login">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="alike-angular-regular 
                  bg-linear-to-r from-[#fd4f89]/60 to-[#fd81ab]/60
                   text-[#ffe6ee] font-bold md:px-8 md:py-4 px-6 py-2 rounded-3xl 
                   shadow-2xl hover:shadow-3xl transition-all duration-300 text-lg lg:text-xl 
                   tracking-wide uppercase z-80"
                  >
                    Welcome back
                  </motion.button>
                </Link>
            ...
            <motion.div
              variants={itemVariants}
              className="lg:order-1 lg:block hidden relative lg:-right-8 xl:-right-12 z-65"
            >
              {/* Glow Ring - z-[55] */}
              <motion.div
