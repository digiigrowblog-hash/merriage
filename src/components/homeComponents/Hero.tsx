  ...
  return (
    <>
      ...
      <div className="fixed top-1/2 -translate-y-1/2 flex justify-center items-center
       right-[-130px] md:right-[-200px] lg:right-[-270px] xl:right-[-320px] pointer-events-none z-0">
        <div className="h-[500px] w-[500px] md:h-[600px] md:w-[600px] lg:h-[650px] lg:w-[650px]">
          <MandalaCanvas />
        </div>
      </div>

      <section className="relative min-h-[80vh] overflow-hidden 
      bg-gradient-to-t from-[#f3c871] via-[#f3b886] to-[#e89b7c]">
        {/* ✅ LAYER 2: Header (z-50) */}
        <Header />
          ...
          >
            ...
            >
              ...
              <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 items-center justify-center lg:justify-start pt-4 z-[70]">
                <div className="alike-angular-regular flex items-center gap-6 bg-white/80 backdrop-blur-sm rounded-3xl p-4 shadow-2xl border border-white/50 z-[70]">
                  ...
                  <div className="text-center">
                    <div className="text-2xl md:text-3xl font-bold text-[#d45b4a]">100%</div>
                    <div className="text-xs uppercase text-[#4d2b22]/80 tracking-wide">Verified</div>
                  </div>
                </div>
            ...
            <motion.div variants={itemVariants} className="lg:order-1 lg:block hidden relative lg:-right-8 xl:-right-12 z-[65]">
              ...
              <motion.div
                ...
                className="pointer-events-none absolute -left-12 -top-8 w-[380px] h-[480px] lg:w-[450px] lg:h-[550px] rounded-full bg-gradient-to-r from-white/30 to-white/10 blur-3xl shadow-2xl z-[55]"
              />
              ...
              <motion.div
                ...
                className="relative w-[320px] h-[400px] lg:w-[420px] lg:h-[520px] bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-xl shadow-2xl rounded-3xl lg:rounded-r-3xl border border-white/40 overflow-hidden z-[65]"
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-transparent rounded-3xl lg:rounded-r-3xl z-[70]" />
                
                {/* Floating Hearts - z-[72] */}
                <div className="absolute top-6 right-6 flex gap-1 z-[72]">
