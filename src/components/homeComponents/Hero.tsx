  ...
  return (
    <section className="relative min-h-[80vh] overflow-hidden bg-linear-to-t from-[#f3c871] via-[#f3b886] to-[#e89b7c]">
      ...
      <div className="mx-auto flex max-w-6xl  items-center px-6 pt-28 pb-16 gap-10">
        ...
        // <div className="relative z-10 flex flex-1 justify-center md:justify-start md:-left-40 ">
        ...
        //      w-full h-full md:h-[920px] md:w-[550px] rounded-full 
        ...
        //     className="relative w-[340px] h-[420px] md:w-[920px] md:h-[550px] items-center
        //      bg-white/10 shadow-2xl backdrop-blur-md overflow-hidden  md:rounded-r-4xl"
        //   >
        //     <Image
        ...
        //        Where Tradition Meets contemporary love.
        //     </p>
        //   </motion.div>
        //   </div>
        // </div>